...
Example: If base directory is `/home/user/.claude/plugins/notify/skills/notify-setup`, then:
```
/home/user/.claude/plugins/notify/skills/notify-setup/scripts/notify.sh
```
