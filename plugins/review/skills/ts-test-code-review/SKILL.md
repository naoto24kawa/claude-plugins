...
- Task ツール (subagent_type: `test-aaa-test-agent`) による Arrange-Act-Assert 構造の評価
- Task ツール (subagent_type: `test-test-double-agent`) による Mock/Stub/Fake の適切性評価
- Task ツール (subagent_type: `test-test-builder-agent`) による Test Data Builder の保守性評価
- Task ツール (subagent_type: `test-solid-test-agent`) による SOLID 原則遵守度の評価
- Task ツール (subagent_type: `review-typescript-comprehensive`) による TypeScript 型安全性とベストプラクティス評価
