...
| 種類 | URL |
|------|-----|
| 仕様 & ベストプラクティス | https://docs.anthropic.com/en/docs/claude-code/sub-agents |

## WebSearch Keywords

```
Claude Code sub-agents best practices site:docs.anthropic.com OR site:code.claude.com
```
