...
2. **テストダブル選択の適切性評価**
   - テスト目的に応じた選択を評価
   - Mock/Stub/Fake/Spy/Dummy の使い分けを確認
   - 過剰なモック化を検出
...
- **過剰なモック化が発生している場合**: 適切なテストダブル種類の選択と削減方法を提案
- **依存関係が密結合な場合**: インターフェース抽出と依存性注入の導入手順を案内
- **レガシーテストコードの場合**: 既存のテストを壊さずに段階的にテストダブルを改善する手順を提示
